...
class User(db.Model):
    ...
    sessions_as_teacher = db.relationship('Session', foreign_keys='Session.teacher_id', lazy=True)
    sessions_as_learner = db.relationship('Session', foreign_keys='Session.learner_id', lazy=True)
